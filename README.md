...
```bash
git clone https://github.com/CodeWithSagarMali/Plant-Disease-Detection-System
```
...
Once the application is running, open your web browser and navigate to app.Upload an image of a plant leaf, and the system will predict if it is affected by any disease.
...
>>>>>>> b5f4bf6a0ec2507d7950f7be69abe15f289a92ed
